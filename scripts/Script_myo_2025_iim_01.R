...
dir.create("output/figures/final", recursive = TRUE)
dir.create("output/tables/final", recursive = TRUE)
dir.create("misc")
dir.create("reports")
...
#### mmt8 ----
# https://www.sthda.com/english/articles/31-principal-component-methods-in-r-practical-guide/115-famd-factor-analysis-of-mixed-data-in-r-essentials
res_d09_famd_m0_mmt8 <- FAMD(
  d09_m0 |>
    select(any_of(var_name_01_mmt8$abbreviation)) |> 
    dplyr::rename(dplyr::any_of(rename_vec)), 
  graph = TRUE
)
# figures
tiff("output/figures/cluster analyses/251118_mmt8_m0_fmda_overview_01.tiff", 
     compression = "lzw",
     res = "300",
     width = 1600,
     height = 1200)
fviz_famd_var(res_d09_famd_m0_mmt8,labelsize = 8,repel = TRUE) +
  theme_minimal(base_size = 16) +   # increases all text size (titles, axis, legend)
  theme(
    plot.title = element_text(size = 25, face = "bold", hjust = 0.5),
    axis.title = element_text(size = 20, face = "bold"),
...
dev.off()
## feature contribution
tiff("output/figures/cluster analyses/251119_mmt8_m0_fmda_feat_contrib_01.tiff", 
     compression = "lzw",
     res = "300",
     width = 1600,
     height = 1200)
fviz_contrib(res_d09_famd_m0_mmt8, "var", axes = 1,labelsize = 8) +
  theme_minimal(base_size = 16) +   # increases all text size (titles, axis, legend)
  theme(
    plot.title = element_text(size = 20, face = "bold", hjust = 0.5),
    axis.title = element_text(size = 18, face = "bold"),
...
dev.off()
## quantitative variables - continuous
tiff("output/figures/cluster analyses/251119_mmt8_m0_fmda_continuous_01.tiff", 
     compression = "lzw",
     res = "300",
     width = 1600,
     height = 1200)
fviz_famd_var(res_d09_famd_m0_mmt8, "quanti.var", col.var = "contrib", 
              gradient.cols = c("#00AFBB", "#E7B800", "#FC4E07"),
              labelsize = 8,
              repel = TRUE) +
  theme_minimal(base_size = 16) +   # increases all text size (titles, axis, legend)
...
dev.off()
## qualitative variables - factors
tiff("output/figures/cluster analyses/251119_mmt8_m0_fmda_factor_01.tiff", 
     compression = "lzw",
     res = "300",
     width = 1600,
     height = 1200)
fviz_famd_var(res_d09_famd_m0_mmt8, "quali.var", col.var = "contrib", 
              gradient.cols = c("#00AFBB", "#E7B800", "#FC4E07"),
              labelsize = 8,
              repel = TRUE) +
  theme_minimal(base_size = 16) +   # increases all text size (titles, axis, legend)
...
## mmt8_categories
tiff("output/figures/cluster analyses/251118_mmt8_m0_fmda_mmt8_cat_01.tiff", 
     compression = "lzw",
     res = "300",
     width = 1600,
     height = 1200)
fviz_mfa_ind(
  res_d09_famd_m0_mmt8,
  habillage = "MMT8 categories",   # color points by your factor
  palette = c("#00AFBB", "#E7B800", "#FC4E07", "#8B4513"),  # optional extra color for 4 levels
  addEllipses = TRUE,
  ellipse.level=0.95,
  repel = FALSE,   # do not show text labels
...
#### mda ----
# https://www.sthda.com/english/articles/31-principal-component-methods-in-r-practical-guide/115-famd-factor-analysis-of-mixed-data-in-r-essentials
res_d09_famd_m0_mda <- FAMD(
  d09_m0 |>
    select(any_of(var_name_01_mda$abbreviation)) |> 
    dplyr::rename(dplyr::any_of(rename_vec)), 
  graph = TRUE
)
# figures
tiff("output/figures/cluster analyses/251118_mda_m0_fmda_overview_01.tiff", 
     compression = "lzw",
     res = "300",
     width = 1600,
     height = 1200)
fviz_famd_var(res_d09_famd_m0_mda,labelsize = 8,repel = TRUE) +
  theme_minimal(base_size = 16) +   # increases all text size (titles, axis, legend)
  theme(
    plot.title = element_text(size = 25, face = "bold", hjust = 0.5),
    axis.title = element_text(size = 20, face = "bold"),
...
dev.off()
## feature contribution
tiff("output/figures/cluster analyses/251119_mda_m0_fmda_feat_contrib_01.tiff", 
     compression = "lzw",
     res = "300",
     width = 1600,
     height = 1200)
fviz_contrib(res_d09_famd_m0_mda, "var", axes = 1,labelsize = 8) +
  theme_minimal(base_size = 16) +   # increases all text size (titles, axis, legend)
  theme(
    plot.title = element_text(size = 20, face = "bold", hjust = 0.5),
    axis.title = element_text(size = 18, face = "bold"),
...
dev.off()
## quantitative variables - continuous
tiff("output/figures/cluster analyses/251119_mda_m0_fmda_continuous_01.tiff", 
     compression = "lzw",
     res = "300",
     width = 1600,
     height = 1200)
fviz_famd_var(res_d09_famd_m0_mda, "quanti.var", col.var = "contrib", 
              gradient.cols = c("#00AFBB", "#E7B800", "#FC4E07"),
              labelsize = 8,
              repel = TRUE) +
  theme_minimal(base_size = 16) +   # increases all text size (titles, axis, legend)
...
dev.off()
## qualitative variables - factors
tiff("output/figures/cluster analyses/251119_mda_m0_fmda_factor_01.tiff", 
     compression = "lzw",
     res = "300",
     width = 1600,
     height = 1200)
fviz_famd_var(res_d09_famd_m0_mda, "quali.var", col.var = "contrib", 
              gradient.cols = c("#00AFBB", "#E7B800", "#FC4E07"),
              labelsize = 8,
              repel = TRUE) +
  theme_minimal(base_size = 16) +   # increases all text size (titles, axis, legend)
...
## mda_categories
tiff("output/figures/cluster analyses/251118_mda_m0_fmda_mda_cat_01.tiff", 
     compression = "lzw",
     res = "300",
     width = 1600,
     height = 1200)
fviz_mfa_ind(
  res_d09_famd_m0_mda,
  habillage = "MDA categories",   # color points by your factor
  palette = c("#00AFBB", "#E7B800", "#FC4E07", "#8B4513"),  # optional extra color for 4 levels
  addEllipses = TRUE,
  ellipse.level=0.95,
  repel = FALSE,   # do not show text labels
...
### UMAP ----
run_umap_plot(
  model_famd        = res_d09_famd_m0_mmt8,
  data              = d09_m0,
  variable_to_plot  = "mda_categories"
)

run_umap_plot(
  model_famd        = res_d09_famd_m0_mmt8, 
  data              = d09_m0, 
  variable_to_plot  = "mmt8_categories"
)


### PLS-DA ----
source("scripts/cluster_plsda_pipeline_2.R")
pls_results <- run_all_plsda(
  df = d09_m0_pls |> 
    select(any_of(var_name_01_mmt8$abbreviation)),
  prefix = "251118_mmt8_m0_pls"
)

run_all_plsda(d09_m0, prefix = "251119_m0_pls")

## delta ----
### FAMD ----
#### mmt8 ----
# https://www.sthda.com/english/articles/31-principal-component-methods-in-r-practical-guide/115-famd-factor-analysis-of-mixed-data-in-r-essentials
res_d09_famd_delta_mmt8 <- FAMD(
  d09_delta |>
    select(any_of(var_name_01_mmt8$abbreviation)) |> 
    dplyr::rename(dplyr::any_of(rename_vec)), 
  graph = TRUE
...
# figures
tiff("output/figures/cluster analyses/251118_mmt8_delta_fmda_overview_01.tiff", 
     compression = "lzw",
     res = "300",
     width = 1600,
     height = 1200)
fviz_famd_var(res_d09_famd_delta_mmt8,labelsize = 8,repel = TRUE) +
  theme_minimal(base_size = 16) +   # increases all text size (titles, axis, legend)
  theme(
    plot.title = element_text(size = 25, face = "bold", hjust = 0.5),
    axis.title = element_text(size = 20, face = "bold"),
...
dev.off()
## feature contribution
tiff("output/figures/cluster analyses/251119_mmt8_delta_fmda_feat_contrib_01.tiff", 
     compression = "lzw",
     res = "300",
     width = 1600,
     height = 1200)
fviz_contrib(res_d09_famd_delta_mmt8, "var", axes = 1,labelsize = 8) +
  theme_minimal(base_size = 16) +   # increases all text size (titles, axis, legend)
  theme(
    plot.title = element_text(size = 20, face = "bold", hjust = 0.5),
    axis.title = element_text(size = 18, face = "bold"),
...
dev.off()
## quantitative variables - continuous
tiff("output/figures/cluster analyses/251119_mmt8_delta_fmda_continuous_01.tiff", 
     compression = "lzw",
     res = "300",
     width = 1600,
     height = 1200)
fviz_famd_var(res_d09_famd_delta_mmt8, "quanti.var", col.var = "contrib", 
              gradient.cols = c("#00AFBB", "#E7B800", "#FC4E07"),
              labelsize = 8,
              repel = TRUE) +
  theme_minimal(base_size = 16) +   # increases all text size (titles, axis, legend)
...
dev.off()
## qualitative variables - factors
tiff("output/figures/cluster analyses/251119_mmt8_delta_fmda_factor_01.tiff", 
     compression = "lzw",
     res = "300",
     width = 1600,
     height = 1200)
fviz_famd_var(res_d09_famd_delta_mmt8, "quali.var", col.var = "contrib", 
              gradient.cols = c("#00AFBB", "#E7B800", "#FC4E07"),
              labelsize = 8,
              repel = TRUE) +
  theme_minimal(base_size = 16) +   # increases all text size (titles, axis, legend)
...
## mmt8_categories
tiff("output/figures/cluster analyses/251118_mmt8_delta_fmda_mmt8_cat_01.tiff", 
     compression = "lzw",
     res = "300",
     width = 1600,
     height = 1200)
fviz_mfa_ind(
  res_d09_famd_delta_mmt8,
  habillage = "MMT8 categories",   # color points by your factor
  palette = c("#00AFBB", "#E7B800", "#FC4E07", "#8B4513"),  # optional extra color for 4 levels
  addEllipses = TRUE,
  ellipse.level=0.95,
...
# figures
tiff("output/figures/cluster analyses/251118_mda_delta_fmda_overview_01.tiff", 
     compression = "lzw",
     res = "300",
     width = 1600,
     height = 1200)
fviz_famd_var(res_d09_famd_delta_mda,labelsize = 8,repel = TRUE) +
  theme_minimal(base_size = 16) +   # increases all text size (titles, axis, legend)
  theme(
    plot.title = element_text(size = 25, face = "bold", hjust = 0.5),
    axis.title = element_text(size = 20, face = "bold"),
...
dev.off()
## feature contribution
tiff("output/figures/cluster analyses/251119_mda_delta_fmda_feat_contrib_01.tiff", 
     compression = "lzw",
     res = "300",
     width = 1600,
     height = 1200)
fviz_contrib(res_d09_famd_delta_mda, "var", axes = 1,labelsize = 8) +
  theme_minimal(base_size = 16) +   # increases all text size (titles, axis, legend)
  theme(
    plot.title = element_text(size = 20, face = "bold", hjust = 0.5),
    axis.title = element_text(size = 18, face = "bold"),
...
dev.off()
## quantitative variables - continuous
tiff("output/figures/cluster analyses/251119_mda_delta_fmda_continuous_01.tiff", 
     compression = "lzw",
     res = "300",
     width = 1600,
     height = 1200)
fviz_famd_var(res_d09_famd_delta_mda, "quanti.var", col.var = "contrib", 
              gradient.cols = c("#00AFBB", "#E7B800", "#FC4E07"),
              labelsize = 8,
              repel = TRUE) +
  theme_minimal(base_size = 16) +   # increases all text size (titles, axis, legend)
...
dev.off()
## qualitative variables - factors
tiff("output/figures/cluster analyses/251119_mda_delta_fmda_factor_01.tiff", 
     compression = "lzw",
     res = "300",
     width = 1600,
     height = 1200)
fviz_famd_var(res_d09_famd_delta_mda, "quali.var", col.var = "contrib", 
              gradient.cols = c("#00AFBB", "#E7B800", "#FC4E07"),
              labelsize = 8,
              repel = TRUE) +
  theme_minimal(base_size = 16) +   # increases all text size (titles, axis, legend)
...
## mda_categories
tiff("output/figures/cluster analyses/251118_mda_delta_fmda_mda_cat_01.tiff", 
     compression = "lzw",
     res = "300",
     width = 1600,
     height = 1200)
fviz_mfa_ind(
  res_d09_famd_delta_mda,
  habillage = "MDA categories",   # color points by your factor
  palette = c("#00AFBB", "#E7B800", "#FC4E07", "#8B4513"),  # optional extra color for 4 levels
  addEllipses = TRUE,
  ellipse.level=0.95,
...
### UMAP ----
run_umap_plot(
  model_famd        = res_d09_famd_delta_mmt8,
  data              = d09_delta,
  variable_to_plot  = "mda_categories"
)
...
pls_results <- run_all_plsda(
  df = d09_delta_pls |> 
    select(any_of(var_name_01_mmt8$abbreviation)),
  prefix = "251118_mmt8_delta_pls"
)

run_all_plsda(d09_delta, prefix = "251119_delta_pls")
