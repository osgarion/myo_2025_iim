...
fviz_famd_var(res_famd_delta, repel = TRUE)
fviz_contrib(res_famd_delta, "var", axes = 1)
...
# vizualizace
plotIndiv(pls_delta, comp = c(1,2), group = d08_delta_pls_Y, ellipse = TRUE, legend=T)
